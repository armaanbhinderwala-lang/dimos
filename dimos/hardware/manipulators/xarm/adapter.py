...
# j6 at -90 sits 10 deg from its -100.3 lower stop and a pull drives it there; -60 keeps the
# same tool direction (pitch is j2+j4+j6) with 40 deg of room.
_XARM7_INITIAL_JOINTS_DEG = [0.0, -30.0, 0.0, 0.0, 0.0, -60.0, 20.0]
