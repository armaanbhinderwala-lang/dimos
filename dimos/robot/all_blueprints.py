...
all_blueprints = {
    ...
    "openft": "dimos.hardware.sensors.force_torque.blueprints.openft:openft",
...
all_modules = {
    ...
    "ft-driver-module": "dimos.hardware.ft_driver_module.FTDriverModule",
    "ft-pull-module": "dimos.hardware.ft_pull_skill.FTPullModule",
    "ft-recorder": "dimos.robot.manipulators.xarm.blueprints.force_torque.FTRecorder",
    "ft-visualizer-module": "dimos.hardware.ft_visualizer_module.FTVisualizerModule",
    ...
    "handle-grab-module": "dimos.hardware.handle_grab_skill.HandleGrabModule",
    ...
    "open-ft-recorder": "dimos.hardware.sensors.force_torque.blueprints.openft.OpenFTRecorder",
    "open-ft-sensor": "dimos.hardware.sensors.force_torque.openft_module.OpenFTSensor",
    ...
    "wrench-plotter": "dimos.visualization.wrench_plotter.WrenchPlotter",
    ...
    "zed-module": "dimos.hardware.zed_camera.ZEDModule",
}
