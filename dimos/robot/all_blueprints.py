...
all_blueprints = {
    ...
    "xarm-force-torque-mock": "dimos.robot.manipulators.xarm.blueprints.force_torque:xarm_force_torque_mock",
...
all_modules = {
    ...
    "mock-ft-sensor": "dimos.hardware.sensors.force_torque.mock.MockFTSensor",
